...
class ColorObjects_HEX(unittest.TestCase):
    @staticmethod
    def CreateColor(hex_str = "#7F7F7F") -> HEX:
        return HEX(hex_str)
    # ------------------------------------------------------------------------------------------------------------------
    # - BASIC Color Object Testing -
    # ------------------------------------------------------------------------------------------------------------------
    def test_repr(self):
        self.assertEqual(repr(self.CreateColor()),"HEX(r=127,g=127,b=127)")

    def test_str(self):
        self.assertEqual(str(self.CreateColor()),"#7f7f7f")
    ...
    def test_dunder_math_tuple(self):
        ...
        self.assertEqual(self.CreateColor()//(4,4,4), RGB(r=31, g=31, b=31))
        self.assertEqual(self.CreateColor()*(2,2,2), RGB(r=254, g=254, b=254))
        self.assertEqual(self.CreateColor("#030303")**(4,4,4), RGB(r=81, g=81, b=81))
        self.assertEqual(self.CreateColor()%(4,4,4), RGB(r=3, g=3, b=3))
