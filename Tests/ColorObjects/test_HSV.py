...
class ColorObjects_HSV(unittest.TestCase):
    ...
    def test_dunder_HEX(self):
        ...
        # math
        self.assertEqual(
            round(color + HEX("#abcdef"),3),
            HSV(210.25,0.785,1)
        )
        self.assertEqual(
            round(color - HEX("#00bb55"),3),
            HSV(0,0,0.017)
        )
        self.assertEqual(
            round(color * HEX("#020302"),3),
        ...
        self.assertEqual(
            round(color // HEX("#050709"),3),
            HSV(0.0,1.0,1)
        )
        self.assertEqual(
            round(color ** HEX("#020101"),3),
            HSV(1.0,0.707,0.998)
        )
        self.assertEqual(
            round(color % HEX("#121664"),3),
            HSV(0.25,0.5,0.358)
        )
    ...
    def test_dunder_HSL(self):
        ...
        # math
        self.assertEqual(
            round(color + HSL(0.125,0.5,0.1),3),
            HSV(0.25,1,0.899)
        )
        self.assertEqual(
            round(color - HSL(0.125,0.5,0.1),3),
        ...
        self.assertEqual(
            round(color * HSL(0,0,0.01),3),
            HSV(0.0,0.0,0.009)
        )
        self.assertEqual(
            round(color / HSL(180,1,.01),3),
            HSV(0.001,0.5,1)
        )
        self.assertEqual(
            round(color // HSL(180,1,.01),3),
        ...
        self.assertEqual(
            round(color ** HSL(0,0,0.006),3),
            HSV(1.0, 1.0, 0.998)
        )
        self.assertEqual(
            round(color % HSL(180,0.2,0.1),3),
