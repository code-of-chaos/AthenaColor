...
# Custom Packages
from AthenaColor.v3_10.Data import *
from AthenaColor.v3_10.InitClass import init
from AthenaColor.v3_10.Objects.ColorSystems import (
    RGB,RGBA,HEX,HEXA,HSV,HSL,CMYK
)
from AthenaColor.v3_10.Objects.Console.Styling import (
...
class ConvertColorObject:
    from AthenaColor.v3_10.Functions.ColorObjectConversion import (
